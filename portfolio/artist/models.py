...
class Artist(models.Model):
    ...
    artist_image = models.ImageField(null =True, upload_to = "covers/", blank = True)
    country = CountryField(null = True, blank = True)
    style = models.CharField(max_length = 15, null =True, blank = True)
    quote = models.CharField(max_length = 255, null = True, blank = True)
    introduction = models.TextField(null =True, blank = True)
    crew = models.CharField(max_length=255, null = True, blank = True)
    ig = models.URLField(max_length=200, null =True, blank = True)
...
class Highlights(models.Model):
    w_artist = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE) #must
    w_context = models.CharField(max_length=255, null = True, blank = False) #must
    w_photo = models.ImageField(null =True, upload_to = "work/", blank = False) #must
    w_date = models.DateField(null = True, blank = True)
    w_content = models.TextField(null = True, blank = True)
    w_link = models.URLField(max_length=200, null = True,  blank = True)
...
class JudgingWorkshop(models.Model):
    ...
    jw_event = models.CharField(max_length = 30, null = True, blank = False) #must
    jw_photo = models.ImageField(null =True, upload_to = "judgingworkshop/", blank = False) #must
    jw_date = models.DateField(null =True, blank = True)
    jw_content = models.TextField(null =True, blank = True)
    jw_link = models.URLField(max_length=200, null =True, blank = True)
...
class Events(models.Model):
    ...
    ev_event = models.CharField(max_length = 20, null = True, blank = False) #must
    ev_photo = models.ImageField(null = True, upload_to = "events_attended/", blank = False) #must
    ev_date = models.DateField(null =True, blank = True)
    ev_content = models.TextField(null = True, blank = True )
    ev_link = models.URLField(max_length=200, null = True, blank = True)
