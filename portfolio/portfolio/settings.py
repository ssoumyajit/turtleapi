...
SECRET_KEY = '!kqb@4k&j!kzjc^4vul8-cw&tpb#926&o@m#&zgg7qu2j8j7@5'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

#ALLOWED_HOSTS = ['0.0.0.0'] #while using docker container
ALLOWED_HOSTS = []
...
MIDDLEWARE = [
    ...
    'django.contrib.auth.middleware.AuthenticationMiddleware',  # should stay after the session middleware
