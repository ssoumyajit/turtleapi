# Generated by Django 2.2.6 on 2021-01-15 07:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('l_liker', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('l_shareid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='lshareids', to='sharing.Sharing')),
            ],
        ),
        migrations.CreateModel(
            name='Comments',
            fields=[
                ...
                ('c_shareid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cshareids', to='sharing.Sharing')),
            ],
        ),
    ]
